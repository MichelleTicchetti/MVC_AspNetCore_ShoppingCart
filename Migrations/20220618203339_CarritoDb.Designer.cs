...
namespace Carrito_A.Migrations
{
    ...
    [Migration("20220618203339_CarritoDb")]
    partial class CarritoDb
    {
            ...
            modelBuilder.Entity("Carrito_A.Models.Direccion", b =>
                {
                    ...
                    b.HasOne("Carrito_A.Models.Sucursal", "Sucursal")
                        .WithOne("Direccion")
                        .HasForeignKey("Carrito_A.Models.Direccion", "SucursalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Carrito_A.Models.Telefono", b =>
                {
                    ...
                    b.HasOne("Carrito_A.Models.Sucursal", "Sucursal")
                        .WithOne("Telefono")
                        .HasForeignKey("Carrito_A.Models.Telefono", "SucursalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
